...
// Accents are tuned in OKLCH against the near-black field (#101014): lightness
// floored around L 0.6 so the blob fill and result-name text read as a glow
// (every accent ≥ 4.5:1 on the base background), chroma lifted to "lively"
// but kept well under neon. Hue carries the species identity — keep it when
// retuning. Grays/whites stay deliberately low-chroma; that IS their identity.
